...
* Desarrollo y mantenimiento de aplicaciones web utilizando **Django y Python**.
* Implementación de nuevas funcionalidades tanto en Frontend como en Backend.
* Optimización de rendimiento y atención a incidencias en entornos productivos.

### 🏢 **SVAM International de México**
> **Ingeniero de Software**
* Participación en el sistema de facturación electrónica **YoFacturo** utilizando **C# y ASP.NET**.
* Desarrollo Full-Stack en el proyecto **HRMS** utilizando **Angular, Node.js y PostgreSQL**.
* Integración de APIs REST y diseño de interfaces web responsivas.
...
<img src="https://raw.githubusercontent.com/Platane/snk/output/github-contribution-grid-snake-dark.svg" alt="Serpiente de contribuciones" />
...
<sub>🎮 Videojuegos • 🎧 Música • 💻 Tecnología • 🖥️ Hardware</sub>
